...
environments_select_q_high <- merge(environments_select_q_high, 
                                    environments_select[,.(environment = unique(environment)), .(group)], 
                                    all = T, by = c("environment", "group")) 
...
group_select <- group_names[1]

fig_biome <- ggplot()+
  geom_tile(data = environments_blue[group %in% group_select ], 
            aes(y = environment, x = x_pos, fill = area_fraction),
            width = 0.95, color = "gray25")+
  geom_text(
    data = environments_blue[group %in% group_select ],
    aes(
      y = environment,
      x = x_pos,
  ...
  geom_tile(data = environments_red[group %in% group_select ], 
            aes(y = environment, x = x_pos, fill = area_fraction),
            width = 0.95, color = "gray25")+
  geom_text(
    data = environments_red[group %in% group_select ],
    aes(
      y = environment,
      x = x_pos,
      label = percent(area_fraction, accuracy = 1),
  ...
  ggnewscale::new_scale_fill() +
  geom_tile(data = environments_purple[group %in% group_select ],
            aes(y = environment, x = x_pos, fill = area_fraction),
            width = 0.95, color = "gray25")+
  geom_text(
    data = environments_purple[group %in% group_select ],
    aes(
      y = environment,
      x = x_pos,
      label = percent(area_fraction, accuracy = 1),
  ...
  labs(y = "Biome", x = NULL,
       title = "Biome fingerprints of product agreement")

### Save figure ----
ggsave(
  filename = paste0(
    PATH_SAVE_PARTITION_EVAP_FIGURES,
    "supplement/fig4_SI_biome_fingerprint.pdf"
  ),
  plot = fig_biome,
  width = figure_widths,
  height = 10,
...
fig_ipcc <- ggplot()+
  ...
  theme_fig4+
  theme(legend.position = "bottom")+
  labs(y = "IPCC reference region", x = NULL,
       title = "IPCC reference region fingerprints of product agreement")
...
ggsave(
  filename = paste0(
    PATH_SAVE_PARTITION_EVAP_FIGURES,
    "supplement/fig4_SI_ipcc_fingerprint.pdf"
  ),
  plot = fig_ipcc,
  width = figure_widths,
  height = 30,
...
fig_kg <- ggplot()+
  ...
  theme_fig4+
  theme(legend.position = "bottom")+
  labs(y = "Köppen Geiger classes", x = NULL,
       title = "Köppen Geiger fingerprints of product agreement")
...
ggsave(
  filename = paste0(
    PATH_SAVE_PARTITION_EVAP_FIGURES,
    "supplement/fig4_SI_kg_beck_fingerprint.pdf"
  ),
  plot = fig_kg,
  width = figure_widths,
  height = 20,
...
group_select <- group_names[4]

fig_landcover <- ggplot()+
  geom_tile(data = environments_blue[group %in% group_select ], 
            aes(y = environment, x = x_pos, fill = area_fraction),
            width = 0.95, color = "gray25")+
  geom_text(
  ...
  theme_fig4+
  theme(legend.position = "bottom")+
  labs(y = "Landcover", x = NULL,
       title = "Landcover fingerprints of product agreement")
...
ggsave(
  filename = paste0(
    PATH_SAVE_PARTITION_EVAP_FIGURES,
    "supplement/fig4_SI_landcover_fingerprint.pdf"
  ),
  plot = fig_landcover,
  width = figure_widths,
  height = 15,
...
fig_all <- ggplot()+
  ...
  labs(y = "Environment", x = NULL,
       title = "Environment fingerprints of product agreement")
...
ggsave(
  filename = paste0(
    PATH_SAVE_PARTITION_EVAP_FIGURES,
    "supplement/fig4_SI_all_fingerprint.pdf"
  ),
  plot = fig_all,
  width = figure_widths,
  height = 40,
