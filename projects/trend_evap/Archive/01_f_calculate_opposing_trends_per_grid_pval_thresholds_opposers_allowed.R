...
evap_trend_summary[ N_pos_0_01 > 8 & N_neg_0_01 == 1, trend_0_01 := "positive_90"]
evap_trend_summary[ N_neg_0_01 > 8 & N_pos_0_01 == 1, trend_0_01 := "negative_90"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_05 > 8 & N_neg_0_05 == 1, trend_0_05 := "positive_90"]
evap_trend_summary[ N_neg_0_05 > 8 & N_pos_0_05 == 1, trend_0_05 := "negative_90"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_1 > 8 & N_neg_0_1 == 1, trend_0_1 := "positive_90"]
evap_trend_summary[ N_neg_0_1 > 8 & N_pos_0_1 == 1, trend_0_1 := "negative_90"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_0_2 > 8 & N_neg_0_2 == 1, trend_0_2 := "positive_90"]
evap_trend_summary[ N_neg_0_2 > 8 & N_pos_0_2 == 1, trend_0_2 := "negative_90"]
...
#### permitting 90 % consensus, i.e. one outlier/opposer with 10 total significant trends
evap_trend_summary[ N_pos_all > 8 & N_neg_all == 1, trend_all := "positive_90"]
evap_trend_summary[ N_neg_all > 8 & N_pos_all == 1, trend_all := "negative_90"]

evap_trend_summary[trend_all == "opposing", p_val_opposing_90_consensus := ">0.2"]
evap_trend_summary[trend_0_2 == "opposing", p_val_opposing_90_consensus := "<=0.2"]
evap_trend_summary[trend_0_1 == "opposing", p_val_opposing_90_consensus := "<=0.1"]
evap_trend_summary[trend_0_05 == "opposing", p_val_opposing_90_consensus := "<=0.05"]
evap_trend_summary[trend_0_01 == "opposing", p_val_opposing_90_consensus := "<=0.01"]
evap_trend_summary[is.na(p_val_opposing_90_consensus), p_val_opposing_90_consensus := "1"]

evap_trend_summary[trend_all %in% c("opposing", "negative_90", "positive_90"), p_val_opposing := ">0.2"]
evap_trend_summary[trend_0_2 %in% c("opposing", "negative_90", "positive_90"), p_val_opposing := "<=0.2"]
evap_trend_summary[trend_0_1 %in% c("opposing", "negative_90", "positive_90"), p_val_opposing := "<=0.1"]
evap_trend_summary[trend_0_05 %in% c("opposing", "negative_90", "positive_90"), p_val_opposing := "<=0.05"]
evap_trend_summary[trend_0_01 %in% c("opposing", "negative_90", "positive_90"), p_val_opposing := "<=0.01"]
