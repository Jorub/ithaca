...
# a. Global ET trends across ET products  ----
## data ----
evap_annual_trend <- readRDS(paste0(PATH_SAVE_EVAP_TREND_TABLES, "data_fig_2_global_evap_trend.rds"))
...
# b. Significant trends are opposing and area fraction bar plots ----
## data ----
evap_index <- readRDS(paste0(PATH_SAVE_EVAP_TREND_TABLES, "data_fig_2_grid_trend_stats.rds"))
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES_MAIN, "fig2_motivation.png"), 
