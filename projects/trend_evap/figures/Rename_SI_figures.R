...
rename_map <- c(
  ...
  "fig_SI_KG_v2.png" = "figS03_koppen_geiger_classes.png",
  ...
  "fig_SI_maps_trends_MOD16A.png" = "figS20_trends_MOD16A.png",
  ...
  "fig_4_SI_global_topology_time_period_stability.png" = "figS28_topology_time_period_stability.png",
  "fig_global_topology_p_value_stability.png" = "figS29_topology_p_value_stability.png",
  "fig4_SI_global_topology_sensitivity_ensemble_composition_a.png" = "figS30_global_topology_sensitivity_ensemble_composition_a.png",
  "fig_4_SI_global_topology_boosters_out.png" = "figS31_global_topology_boosters_out.png",
  "fig_5_SI_regional_clustering_dendogram.png" = "figS32_regional_clustering_dendogram.png",
  "SI_fig_topology_ipcc_africa.png" = "figS33_topology_ipcc_africa.png",
  "SI_fig_topology_ipcc_asia.png" = "figS34_topology_ipcc_asia.png",
  "SI_fig_topology_ipcc_australasia.png" = "figS35_topology_ipcc_australasia.png",
  "SI_fig_topology_ipcc_europe.png" = "figS36_topology_ipcc_europe.png",
  "SI_fig_topology_ipcc_north_america.png" = "figS37_topology_ipcc_north_america.png",
  "SI_fig_topology_ipcc_south_america.png" = "figS38_topology_ipcc_south_america.png"
)
