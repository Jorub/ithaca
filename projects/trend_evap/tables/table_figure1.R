...
evap_annual_trend <- readRDS(paste0(PATH_SAVE_EVAP_TREND_TABLES, "data_fig_2_a_global_evap_trend.rds"))

write.table(evap_annual_trend, paste0(PATH_SAVE_EVAP_TREND_TABLES, "global_evap_trends_by_product.csv"), 
                                      sep = ",", dec = ".", row.names = FALSE)


evap_trend_stats <- readRDS(paste0(PATH_SAVE_EVAP_TREND_TABLES, "data_fig_2_b_c_grid_quartile_stats.rds"))
