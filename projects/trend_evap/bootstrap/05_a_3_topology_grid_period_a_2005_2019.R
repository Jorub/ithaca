...
evap_trend <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "global_grid_per_dataset_evap_slope_bootstrap_2005_2019.rds"))  
evap_trend_summary <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "global_grid_topology_input_period_a.rds"))
...
saveRDS(evap_trend_merge[,.(lon, lat, dataset, pos_signal, neg_signal, signal_dampener,
        ...
        paste0(PATH_SAVE_EVAP_TREND, "global_grid_topology_period_a.rds"))
