...
lat_sums_area <- lat_data[, .(sum_N_pos_0_01 = sum(N_pos_0_01*area),
...
evap_sums_melt <- melt(lat_sums_area,
...
evap_sums_melt[, rank_datasets := rank(-value, ties = "first"), .(variable, lat_brk)]

saveRDS(evap_sums_melt, paste0(PATH_SAVE_EVAP_TREND, "lat_groups_ranked_datasets_signal_booster_p_thresholds_bootstrap.rds"))
