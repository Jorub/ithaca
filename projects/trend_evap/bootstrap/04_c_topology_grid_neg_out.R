...
evap_trend <- evap_trend[!dataset %in% c("bess", "fldas")]

evap_trend_summary <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "global_grid_topology_input_neg_boosters_out.rds"))
...
saveRDS(evap_trend_merge[,.(lon, lat, dataset, pos_signal, neg_signal, signal_dampener,
        ...
        paste0(PATH_SAVE_EVAP_TREND, "global_grid_topology_neg_out.rds"))
