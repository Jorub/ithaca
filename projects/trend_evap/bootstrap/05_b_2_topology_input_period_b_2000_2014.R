# Topology input sensitivity period b ----

source('source/evap_trend.R')

## Data ----
### Input data generated in trend_evap/bootstrap/05_b_1 
evap_trend <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "global_grid_per_dataset_evap_slope_intersection_lat_lon_bootstrap_2000_2014.rds"))  
evap_trend_sel <- subset(evap_trend, select = c("dataset", "lon", "lat", "p", "slope", "lower", "upper"))
write.csv(evap_trend_sel, paste0(PATH_SAVE_EVAP_TREND_TABLES, "global_grid_trends_all_datasets_2000_2014.csv"))
...
## Save data ----
saveRDS(evap_trend_summary, paste0(PATH_SAVE_EVAP_TREND, "global_grid_topology_input_period_b.rds"))
