...
topo_grid <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "global_grid_topology_period_b.rds"))
...
saveRDS(topo_grid_cast, paste0(PATH_SAVE_EVAP_TREND, "global_topology_period_b.rds"))
